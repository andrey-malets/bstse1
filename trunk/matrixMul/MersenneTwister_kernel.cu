...
////////////////////////////////////////////////////////////////////////////////
//__global__ void RandomGPU(int nPerRng,int size, float *src_v, float *src_w, float *dst_v, float *dst_w, int size, float c1, float c2, float dt, float D, float M)
//{
...
//
//
//	//cons int tid = threadIdx.x * size + threadIdx.y;
//
//
...
//		if (iOut%2 == 0) x1 = ((float)x + 1.0f) / 4294967296.0f;
//		else
//		{
//			x2 = ((float)x + 1.0f) / 4294967296.0f;
//		//	BoxMuller(x1,x2);
//		//	step( src_v, src_w, dst_v, dst_w, size, c1, c2, dt, D, M, x1,x2)
//
//		}
//    }
//}
